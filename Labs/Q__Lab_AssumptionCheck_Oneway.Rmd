...
A one-way ANOVA revealed a statistically significant difference across the four groups, 
...
Looking at the adjusted p values, only condition 1 vs. condition 2 and condition 2 vs condition 4 are significantly different from each other.This is different from what they report in the paper, where they also say that condition 2 vs 3 (reactivation plus tetris vs tetris only) is significant.
